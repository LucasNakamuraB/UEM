class Selecao:
    ...
    def move_direita(self):
        ...
        4
        '''
        if self.col_in < self.incell:
            self.col_in += 1
        elif self.col_end > self.incell or self.incell == self.col_end == self.col_in:
            self.col_end += 1
        return
    ...
    def move_esquerda(self):
        ...
        6
        '''
        if self.col_in < self.incell or self.incell == self.col_end == self.col_in:
            self.col_in -= 1
        elif self.col_end > self.incell:
            self.col_end -= 1
        return
